...
from res.getero.wafer_generator import WaferGenerator
from res.frontend.getero.wafer_plot import WaferPlotFrame
...
class ControlPanel(Frame):
    ...
    def initUI(self):
        ...
        self.num_iter.trace("w", lambda name, index, mode, status=self.num_iter_status_text, colr=self.num_iter_status_lbl,
        ...
        self.num_per_iter.trace("w",
                            lambda name, index, mode, status=self.num_per_iter_status_text, colr=self.num_per_iter_status_lbl,
                                   value=self.num_per_iter: self.num_per_iter_callback(name, index, mode, status, colr,
                                                                               value))
