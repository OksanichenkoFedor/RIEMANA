...
def process_one_particle(counter_arr, is_full_arr, border_layer_arr, NodeList,
    ...
    while unfound and not_max_value:
        ...
        if is_collide:
            ...
            #print(x_collide, y_collide, curr_att_x, curr_att_y)
...
@clever_njit(do_njit=do_njit, cache=cache, parallel=parallel)
def process_particles(counter_arr, is_full_arr, border_layer_arr, NodeList, params_arr, Si_num, xsize, ysize, R, test, do_half,
                      max_value=-1.0):
    if test:
    ...
    for i in range(len(params_arr)):
        ...
        process_one_particle(counter_arr, is_full_arr, border_layer_arr, NodeList,
                             returned_particles, arr_x, arr_y, rarr_x, rarr_y,
