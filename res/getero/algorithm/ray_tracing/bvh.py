...
def build_node(curr_edges, NodeList, left_index, right_index, curr_node):
    ...
    if right_index-left_index>1:
        delta_x = np.max(curr_edge[:, :2]) - np.min(curr_edge[:, :2])
        delta_y = np.max(curr_edge[:, 2:4]) - np.min(curr_edge[:, 2:4])
        ...
        NodeList[curr_node, 3], NodeList[curr_node, 4] = np.min(curr_edge[:, :2]), np.max(curr_edge[:, :2])
        NodeList[curr_node, 5], NodeList[curr_node, 6] = np.min(curr_edge[:, 2:4]), np.max(curr_edge[:, 2:4])
