...
def process_particles(counter_arr, is_full_arr, is_hard, add_segments, border_layer_arr, params_arr, Si_num, xsize, ysize, R, test, do_half,
    ...
    for i in range(len(params_arr)):
        ...
        if type=="cell by cell":
            add_segments = cbc_pp(counter_arr, is_full_arr, is_hard, add_segments, border_layer_arr,
            ...
            add_segments = old_cbc_pp(counter_arr, is_full_arr, is_hard, add_segments, border_layer_arr,
                       returned_particles, arr_x, arr_y, rarr_x, rarr_y,
                       curr_params_arr, Si_num, xsize, ysize, R, test, do_half, max_value, num_one_side_points)
        elif type=="line search":
            NodeList, add_segments = segm_pp(counter_arr, is_full_arr, is_hard, add_segments, border_layer_arr, NodeList,
                               returned_particles, arr_x, arr_y, rarr_x, rarr_y, curr_params_arr, Si_num, xsize, ysize,
                               R, test, do_half, max_value, "line search", num_one_side_points, seed)
        elif type=="bvh":
            NodeList, add_segments = segm_pp(counter_arr, is_full_arr, is_hard, add_segments, border_layer_arr, NodeList,
                               returned_particles, arr_x, arr_y, rarr_x, rarr_y,
    ...
    return returned_particles, arr_x, arr_y, rarr_x, rarr_y, NodeList, add_segments