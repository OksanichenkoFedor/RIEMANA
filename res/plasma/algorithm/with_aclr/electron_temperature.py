...
@jit(nopython=True)
def count_ks(T_e, n_vector, param_vector):
    ...
    k_1, k_2, k_3, k_4, k_5, k_13 = count_ks_chem(T_e)
...
@jit(nopython=True)
def count_T_e(n_vector, param_vector):
    n_cl, n_cl2, n_ar, n_cl_plus, n_cl2_plus, n_ar_plus, n_plus, n_e, n_cl_minus = n_vector
    ...
    k_s = count_ks(curr_T_e, n_vector, param_vector)
